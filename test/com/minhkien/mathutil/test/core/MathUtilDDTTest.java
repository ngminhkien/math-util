...
//câu lệnh này cảu JUnit báo hiệu rằng cần loop qua tập data để
...
public class MathUtilDDTTest {
    ...
    public int n; //biến map với value cảu cột 0 của mảng
    ...
    @Test
    public void testGetFactorialGivenArfumentReturnsWell() {
